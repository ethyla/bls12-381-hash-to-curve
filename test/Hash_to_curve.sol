...
contract Hash_to_curveTest is Test {
    ...
    function test_expand_msg_xmd() public view {
        bytes32[] memory result = hasher.expand_msg_xmd("", 0x20, DST);
        bytes
    ...
    function test_expand_msg_abc_0x20() public view {
        bytes32[] memory result = hasher.expand_msg_xmd("abc", 0x20, DST);
        bytes
    ...
    function test_expand_msg_empty_0x80() public view {
        bytes32[] memory result = hasher.expand_msg_xmd("", 0x80, DST);
        bytes
    ...
    function test_expand_msg_abc_0x80() public view {
        bytes32[] memory result = hasher.expand_msg_xmd("abc", 0x80, DST);
        bytes
    ...
    function test_hash_to_field_empty_msg() public view {
        ...
        bytes[2][2] memory result = hasher.hash_to_field_fp2("", custom_dst);
        bytes
        ...
        console.logBytes(expected00);
        console.logBytes(expected01);
        console.logBytes(expected10);
        console.logBytes(expected11);
    ...
    function test_hash_to_field_msg_abc() public view {
        bytes
            memory custom_dst = "QUUX-V01-CS02-with-BLS12381G2_XMD:SHA-256_SSWU_RO_";
        bytes[2][2] memory result = hasher.hash_to_field_fp2("abc", custom_dst);
    ...
    function test_hash_to_field_g1_empty_msg() public view {
        ...
        bytes[2] memory result = hasher.hash_to_field_fp("", custom_dst);
        bytes
    ...
    function test_hash_to_field_g1_msg_abc() public view {
        bytes
            memory custom_dst = "QUUX-V01-CS02-with-BLS12381G1_XMD:SHA-256_SSWU_RO_";
        bytes[2] memory result = hasher.hash_to_field_fp("abc", custom_dst);
        bytes
